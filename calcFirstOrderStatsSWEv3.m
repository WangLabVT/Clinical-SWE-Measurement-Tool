%calcFirstOrderStatsSWEv3.m

%v3 update 9/17/2025 formula for calculating shear wave speed corrected
...
function [stats, speed_data] = calcFirstOrderStatsSWEv3(grayscaleImage, maxShearModulus)
    ...
    speed_data = sqrt(mod_data./3); %experimentally determined relationship
